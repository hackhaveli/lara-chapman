  ...
  return (
    <div className="py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl font-bold text-[#333333] mb-6 font-serif">Meet Lara Chapman</h1>
          <p className="text-xl text-[#555555] max-w-2xl mx-auto">
            Your trusted partner in Phoenix Valley real estate
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="bg-[#E76F51]/10 p-6 rounded-2xl">
              <h3 className="text-xl font-bold text-[#333333] mb-3">My Commitment to You</h3>
              <p className="text-[#555555]">
                Real estate is more than just buying and selling property—it's about helping people transition 
                to new chapters in their lives. I'm committed to making that transition as smooth, successful, 
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/40 to-black/20 flex items-center justify-center">
              <div className="text-center text-white max-w-2xl mx-auto px-6">
                <h3 className="text-3xl font-bold mb-4 font-serif">Living the Phoenix Valley Dream</h3>
                <p className="text-xl">
                  From desert hiking trails to world-class dining, let me help you find your perfect place 
